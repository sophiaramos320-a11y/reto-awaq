...
namespace Unity.Services.CloudBuild.Editor
{
    static class BuildAutomationDashboardUrls
    {
        ...
        const string k_DocsBase = "https://docs.unity.com/en-us/build-automation";
        ...
        public static string GetBuildSigningUrl() => $"{k_DocsBase}/sign-build-artifacts";
        ...
        public static string GetPackageOverviewUrl() => $"{k_DocsBase}/build-automation-editor-package";
