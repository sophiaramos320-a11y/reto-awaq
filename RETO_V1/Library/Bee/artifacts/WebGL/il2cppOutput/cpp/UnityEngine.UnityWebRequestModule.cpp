...
IL_0059:
	...
	}
	{
		...
		il2cpp_codegen_runtime_class_init_inline(Uri_t1500A52B5F71A04F5D05C0852D0F2A0941842A0E_il2cpp_TypeInfo_var);
		bool L_23;
		L_23 = Uri_TryCreate_m183077985BD7B1BE8DBDBCC4604F775C44723EC9(L_22, 1, (&V_2), NULL);
		if (L_23)
		{
			goto IL_0087;
		}
	}
	{
		...
		FormatException__ctor_mE04AEA59C0EEFF4BD34B7CE8601F9D331D1D473E(L_24, _stringLiteral6EC9B8634CD99C1B15ADA83AC13CCF4DCB899E1A, NULL);
		V_3 = L_24;
		V_2 = (Uri_t1500A52B5F71A04F5D05C0852D0F2A0941842A0E*)NULL;
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR String_t* WebRequestUtils_MakeUriString_mC95B57536DF28E6A9FE768A31BD7CE6AC976D837 (Uri_t1500A52B5F71A04F5D05C0852D0F2A0941842A0E* ___0_targetUri, String_t* ___1_targetUrl, bool ___2_prependProtocol, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		String_t* L_17 = V_0;
		bool L_18;
		L_18 = String_op_Equality_m030E1B219352228970A076136E455C4E568C02C1(L_17, _stringLiteralEB3DF58228CDA6AA5325549ADFCEDF52FC5CBF6A, NULL);
		if (!L_18)
		{
			goto IL_00bf;
		}
	...
	{
		Uri_t1500A52B5F71A04F5D05C0852D0F2A0941842A0E* L_19 = ___0_targetUri;
		String_t* L_20;
		L_20 = Uri_get_AbsolutePath_mABB93DD30D4C0F11948DE5C117650B1C3A9925CA(L_19, NULL);
		V_2 = L_20;
		String_t* L_21 = V_2;
		bool L_22;
		L_22 = String_Contains_m6D77B121FADA7CA5F397C0FABB65DA62DF03B6C3(L_21, _stringLiteral6C066B34F4DB79023C0642AFBC43B25A5327F710, NULL);
		if (!L_22)
		{
			goto IL_0073;
		}
...
IL_0073:
	{
		String_t* L_25 = V_2;
		bool L_26;
		L_26 = String_StartsWith_mF75DBA1EB709811E711B44E26FF919C88A8E65C0(L_25, _stringLiteral225454A90D745E7A7A5DE5C12169566FBC05370D, NULL);
		if (!L_26)
		{
			goto IL_00b0;
		}
	...
	}
	{
		String_t* L_29 = V_2;
		Il2CppChar L_30;
		L_30 = String_get_Chars_mC49DF0CD2D3BE7BE97B3AD9C995BE3094F8E36D3(L_29, 6, NULL);
	...
	}
	{
		...
		L_32 = StringBuilder_Append_m08904D74E0C78E5F36DCD9C9303BDD07886D9F7D(L_31, _stringLiteral218F5A08519088A96BE3C1074984C53EA49F1CCA, NULL);
		StringBuilder_t* L_33 = V_1;
		String_t* L_34 = V_2;
		String_t* L_35;
		L_35 = String_Substring_m6BA4A3FA3800FE92662D0847CC8E1EEF940DF472(L_34, 5, NULL);
...
IL_00bf:
	{
		...
		Uri_t1500A52B5F71A04F5D05C0852D0F2A0941842A0E* L_43 = ___0_targetUri;
		String_t* L_44;
		L_44 = Uri_get_PathAndQuery_m33B64A4AAF08510C0199CF5A85918B91D1008E5C(L_43, NULL);
		...
		String_t* L_48;
		L_48 = Uri_get_Fragment_m3CB7AD14DA9618ADE406039D4713F67D6951D835(L_47, NULL);
...
IL_00e0:
	{
		String_t* L_52 = ___1_targetUrl;
		bool L_53;
		L_53 = String_Contains_m6D77B121FADA7CA5F397C0FABB65DA62DF03B6C3(L_52, _stringLiteral6C066B34F4DB79023C0642AFBC43B25A5327F710, NULL);
		if (!L_53)
		{
			goto IL_00f4;
		}
	...
	{
		Uri_t1500A52B5F71A04F5D05C0852D0F2A0941842A0E* L_54 = ___0_targetUri;
		String_t* L_55;
		L_55 = Uri_get_OriginalString_m3031F9054CA10F2C55C0E2415CC19810D360A5D6(L_54, NULL);
		return L_55;
	}
...
IL_00f4:
	{
		...
		String_t* L_57;
		L_57 = Uri_get_AbsoluteUri_m080934F4F2E2160EBEABDF00F8B6D59888EA63AE(L_56, NULL);
		return L_57;
	}
}
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR String_t* WebRequestUtils_URLDecode_m7105E58E9157A90FF279F54E4B9B68EFDD3EF140 (String_t* ___0_encoded, const RuntimeMethod* method) 
